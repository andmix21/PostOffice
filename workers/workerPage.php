...
$client_info = get_client_info_by_id(1);
?>
...
<body>
    ...
    <div class="nav">
        <ul>
            ...
            <li><a href="/PostOffice/workers/workerPage.php">Сотрудники</a></li>
    ...
    <section class = "add_and_find_client">
        <div class = "add_and_find_client_button">
            <a href = "workerAddPage.php">Добавить нового сотрудника</a>
        </div>
    </section>
    <div class = "table">
        <table>
            <thead><th>Код</th><th>Фамилия</th><th>Имя</th><th>Отчество</th><th>Пол</th><th>Место работы</th><th>Должность</th><th>Редактировать</th><th>Удалить</th></thead>
            <?php
